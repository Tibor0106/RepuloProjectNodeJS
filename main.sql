...
CREATE TABLE about(id INTEGER PRIMARY KEY AUTOINCREMENT, title  TEXT NOT NULL, message TEXT NOT NULL);
CREATE TABLE ticketCategories(categoryId INTEGER PRIMARY KEY AUTOINCREMENT, categoryName TEXT NOT NULL);
CREATE TABLE jarat_foglalas (id INTEGER PRIMARY KEY AUTOINCREMENT, flightId INTEGER NOT NULL, fullName TEXT NOT NULL, email TEXT NOT NULL, phone TEXT NOT NULL);
CREATE TABLE kocsi_foglalas (id INTEGER PRIMARY KEY AUTOINCREMENT, flightId INTEGER NOT NULL, fullName TEXT NOT NULL, email TEXT NOT NULL, phone TEXT NOT NULL);
CREATE TABLE rentcars(id INTEGER PRIMARY KEY AUTOINCREMENT, carInfo TEXT NOT NULL);
-- Add a flight:
